    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          ...
          <div class="card my-4">
            ...
            <div class="card-body">
              <img class="d-flsex mr-3 rounded"
                src="https://media.glassdoor.com/sql/267510/nespresso-usa-squarelogo.png" alt="">
          ...
          <!-- Payment Form -->
          <div class="card my-4">
            <h5 class="card-header">eChèque</h5>
            <div class="card-body">
              ...
              <form>
                <div class="form-group">
                  ...
                  <p>
                    <div class="row">
                      <div class="col">
                        <input class="form-control" type="text" placeholder="85,00 €" readonly>
                      </div>
                      <div class="col">
